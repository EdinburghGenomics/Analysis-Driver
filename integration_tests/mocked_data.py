...
mocked_lane_artifact_pool = NamedMock(
    ...
    input_artifact_list=Mock(return_value=[
        NamedMock(real_name='LP6002014-DTP_A01', reagent_labels=['D701-D502 (ATTACTCG-ATAGAGGC)'],
                  samples=[MockedSamples(real_name='10015AT0001')]),
        NamedMock(real_name='LP6002014-DTP_A02', reagent_labels=['D702-D502 (TCCGGAGA-ATAGAGGC)'],
                  samples=[MockedSamples(real_name='10015AT0002')]),
        NamedMock(real_name='LP6002014-DTP_A03', reagent_labels=['D703-D502 (CGCTCATT-ATAGAGGC)'],
                  samples=[MockedSamples(real_name='10015AT0003')]),
        NamedMock(real_name='LP6002014-DTP_A04', reagent_labels=['D704-D502 (GAGATTCC-ATAGAGGC)'],
                  samples=[MockedSamples(real_name='10015AT0004')]),
        NamedMock(real_name='LP6002014-DTP_A05', reagent_labels=['D705-D502 (ATTCAGAA-ATAGAGGC)'],
                  samples=[MockedSamples(real_name='10015AT0005')]),
        NamedMock(real_name='LP6002014-DTP_A06', reagent_labels=['D706-D502 (GAATTCGT-ATAGAGGC)'],
                  samples=[MockedSamples(real_name='10015AT0006')]),
        NamedMock(real_name='LP6002014-DTP_A07', reagent_labels=['D707-D502 (CTGAAGCT-ATAGAGGC)'],
