...
def output_sample_data(sample_id, intput_dir, output_dir, output_config, query_lims=True, rsync_append=True):
    exit_status = 0
    ...
    command = rsync_from_to(dir_with_linked_files, output_loc, append_verify=rsync_append)
