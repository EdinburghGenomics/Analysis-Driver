...
def build_pipeline(dataset):
    ...
    haplotype = stage(v.HaplotypeCaller, input_bam=v.GATKStage.sorted_bam, previous_stages=bam_file_production)
    ...
    vcfstats = stage(qc.VCFStats, vcf_file=v.GATKStage.filter_snp_vcf, previous_stages=[filter_snp])
